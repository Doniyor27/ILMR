                ...
                >
                    <SwiperSlide>
                        <div className="opinion__left-item">
                            <img src={Item1} alt="" className="opinion__left-img" />
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="opinion__left-item">
                            <img src={Item2} alt="" className="opinion__left-img" />
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className="opinion__left-item">
                            <img src={Item3} alt="" className="opinion__left-img" />
                        </div>
                    </SwiperSlide>
                </Swiper>
            </div>
            ...
            >
                <div className="navigation-wrap">
                    <button className="navBtnRight navArr">
                        <img src={LeftBtn} alt="" className="navBtnRightArrow" />
                    </button>
                    <button className="navBtnLeft navArr">
                        <img src={RightBtn} alt="" className="navBtnLeftArrow" />
                    </button>
                </div>
