...
const content1 = `Аholi bandligini taʼminlashning hududiy va tarmoq dasturlarini ishlab chiqish, takomillashtirish va ijtimoiy-iqtisodiy baholash boʼyicha loyiha`
const content2 = `Uy xoʼjaliklarini bandlik masalalari boʼyicha oʼrganish va boshqa dala tadqiqotlarini tashkil qilish guruhi`
const content3 = `Mehnat munosabatlari va mehnatga haq toʼlashni rivojlantirish boʼyicha loyiha`
                ...
                <SwiperSlide>
                    <div className="swipe-wrapper">
                        <div className="projects-carousel__content red-shadow">
                            <img src={CarouselIcon} alt="humans" className="projects-carousel__content-icon" />
                            <p className="projects-carousel__content-text">
                                {content1?.length < 100 ? content1 : content1.slice(0,100) + "..."}
                            </p>
                        </div>
                        <div className="projects-carousel__more red-background">
                            <p className="projects-carousel__more-link">Batafsil</p>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className="swipe-wrapper">
                        <div className="projects-carousel__content yellow-shadow">
                            <img src={CarouselIcon} alt="humans" className="projects-carousel__content-icon" />
                            <p className="projects-carousel__content-text">
                                {content2?.length < 100 ? content2 : content2.slice(0,100) + "..."}
                            </p>
                        </div>
                ...
                <SwiperSlide>
                    <div className="swipe-wrapper">
                        <div className="projects-carousel__content blue-shadow">
                            <img src={CarouselIcon} alt="humans" className="projects-carousel__content-icon" />
                            <p className="projects-carousel__content-text">
                                {content3?.length < 100 ? content3 : content3.slice(0,100) + "..."}
                            </p>
                        </div>
